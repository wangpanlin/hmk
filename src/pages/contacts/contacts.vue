	...
	<view>
		<view class="contacts" v-if="contactsData && contactsData.length !==0">
				...
				<view class="flex">
					...
					<view>
						<view class="cu-avatar-group">
							...
							<view class="renshu">+{{contactsData.count}}</view>
						</view>
					</view>
				</view>
			</view>
			...
			<view class="item2" v-if="contactsData.my_js">
					<lazy-image :realSrc="imgUrl2 + contactsData.my_js.head_img" placeholdSrc=""></lazy-image>
				<view class="v1">
			...
			<view class="item2 t2" v-if="contactsData.my_tj" v-for="(item,index) in contactsData.my_tj" :key="index">
