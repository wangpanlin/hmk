...
<template name="zy-search">
	<view>
		<view class="search">
			<!-- #ifdef APP-PLUS -->
			<text class="voice-icon icon" @click="startRecognize()">&#xe649;</text>
			<!-- #endif -->
			...
			<text @click="searchStart()" class="search-icon icon">&#xe618;</text>
		</view>
		<template v-if="isBlock">
			<view class="s-block" v-if="hList.length > 0">
				<view class="header">
					历史记录
					<text @click="delhistory" class="icon">&#xe625;</text>
