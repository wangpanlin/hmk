		...
		<view class="oper-wrapper" :style="{display: styleDisplay}">
			<view class="oper">
				<view class="btn-wrapper" v-if="showOper">
					<view class="fangshi" @click="fSelect"  hover-class="hover" ><text>重选</text></view>
					<view class="fangshi" @click="fClose"  hover-class="hover" ><text>关闭</text></view>
					<view class="fangshi" @click="fRotate"  hover-class="hover" :style="{display: btnDsp}"><text>旋转</text></view>
					<view class="fangshi" @click="fPreview" hover-class="hover"><text>预览</text></view>
					<view class="fangshi" @click="fUpload"  hover-class="hover"><text>上传</text></view>
				</view>
	...
	export default {
		...
		data() {
			return {
				...
				showOper: true,
				imgSrc: {
					imgSrc: '../../static/images/my/headImg.png'
				},
				btnWidth: '19%',
				btnDsp: 'flex',
			};
